![SylvaNote](attachment://019b76da-a800-7000-8000-0000000000a1)

Welcome to SylvaNote - a self-hosted home for your notes and your work, built so that you and your AI agents can both use it.
...
- **Boards** is kanban. The **Learn SylvaNote** board is already there with a short checklist to work through.
- **Settings** holds the theme, the editor options, the sync server, and the application log.
...
- [ ] Open the Learn SylvaNote board and drag a card to Done

Your notes live in a single SQLite file on this machine. Nothing leaves it until you point the app at a server of your own.
