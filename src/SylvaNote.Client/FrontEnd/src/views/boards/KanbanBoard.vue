...
<template>
  <div class="h-full overflow-x-auto overflow-y-hidden">
    ...
    <div class="h-full w-max min-w-full flex items-start gap-3 p-3">
      ...
      <button
        class="w-64 shrink-0 flex items-center justify-center gap-1.5 h-9 rounded-lg border border-dashed border-border text-sm text-on-surface-muted hover:text-on-surface hover:bg-surface-alt"
        @click="addColumn">
