...
{
    // GaldrJson with the camelCase policy is the payload wire format; this wrapper exists
    // because the GaldrJson class shares its namespace name and the options must be
